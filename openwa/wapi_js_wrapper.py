...
class WapiJsWrapper(object):
    ...
    def __dir__(self):
        ...
        if result := self.driver.execute_script(
            ...
            if self.wapi_version == 'master':
                ...
                self.wapi_version = json.loads(
                    requests.get(
                        'https://raw.githubusercontent.com/open-wa/wa-automate-nodejs/master/package.json'
                    ).content
                )['version']
            ...
            # Fix for elusive webpack object
            self.driver.execute_script(
                'if(window.webpackChunkwhatsapp_web_client) {window.webpackChunkbuild = window.webpackChunkwhatsapp_web_client} else {(function(){const f = Object.entries(window).filter(([,o])=>o && o.push && (o.push != [].push));if(f[0]) {window.webpackChunkbuild = window[f[0][0]]}})()} return (typeof webpackChunkbuild !== "undefined")')
            ...
            if self.wapi_driver.license_key:
                ...
                if isinstance(me, dict):
                    me = me['me']
                    me = me['user'] if isinstance(me, dict) else me.split('@')[0]
...
class JsArg(object):
    ...
    def __str__(self):
        ...
        return 'null' if self.obj is None else str(self.obj)
        ...
        while self.running:
            try:
                ...
                if isinstance(new_js_acks, list) and len(new_js_acks) > 0:
                    new_acks = [
                        factory_message(js_ack, self.wapi_driver)
